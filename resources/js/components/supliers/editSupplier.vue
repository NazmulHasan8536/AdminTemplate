    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mt-5">
                ...
                <li class="breadcrumb-item active" aria-current="page"><router-link to="">Edit Supplier</router-link></li>
            </ol>
        </nav>
            ...
            <div class="col-lg-12">
                <div class="card border-0 rounded-lg mt-5">
                    <div class="card-header  d-flex align-items-center justify-content-between mt-4 mb-0">
                        <h3 class="text-left font-weight-light my-4">Update Supplier</h3>
                    ...
                    <div class="card-body" style="border: 1px solid antiquewhite;">
                        <form @submit.prevent="supplierUpdate" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <button type='submit' class="btn btn-outline-primary btn-block">Update Supplier</button>
                            </div>
                        </form>
                    </div>
                </div>
