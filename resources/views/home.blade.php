...
<div class="container-scroller">
    ...
    <div id="app">
        <div id="topbar"  style="display: none;" v-show="$route.path === '/' || $route.path === '/register'  || $route.path === '/forget' ? false : true">
                ...
                <li class="nav-item nav-profile dropdown">
                    ...
                    <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                        ...
                        <router-link class="dropdown-item" to='/logout'>
                            <i class="mdi mdi-logout mr-2 text-primary" ></i> Signout </router-link>
                    </div>
                </li>
...
{{--                                <img src="{{asset('./backend/assets/images/faces/face4.jpg')}}')}}" alt="image" class="profile-pic">--}}
    ...
    <div class="container-fluid page-body-wrapper">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar" style="display: none;" v-show="$route.path === '/' || $route.path === '/register'  || $route.path === '/forget' ? false : true">
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="ui-basic">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <router-link class="nav-link" to="/employees">All Employee</router-link></li>
                            <li class="nav-item"> <router-link class="nav-link" to="/store-Employee">Add Employee</router-link></li>
                        </ul>
                    </div>
                </li>
